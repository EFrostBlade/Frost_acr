...
{
    internal class BOSS中_战逃外强化圣灵即将过期 : Frost_PLD_ISlotResolver
    {
        public override int Check()
        {
            ...
            if (BattleData.赎罪剑预备剩余时间 > 0 && BattleData.赎罪剑预备剩余时间 < 6)
            {
                if (BattleData.神圣魔法效果提高剩余时间 > 6)
                {
                    return -4;
                }
            }
            if (BattleData.神圣魔法效果提高剩余时间 > 3)
            {
                return -5;
            }
