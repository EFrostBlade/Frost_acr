...
namespace Frost.Frost_BLM.Frost_BLM_Data
{
    ...
    internal class Frost_BLM_BattleData
    {
        public static Frost_BLM_BattleData Instance = new();
        ...
        public float 连击剩余时间 = 0;
        public ulong 上次挑衅目标 = 0;
        public ulong 上次投盾目标 = 0;
        public bool 当前GCD用过减伤 = false;
        public bool 调停溢出提醒 = false;
        ...
        public double 战逃反应冷却时间 = 0;
        public float 战逃反应剩余时间 = 0;
        public float 安魂祈祷剩余时间 = 0;
        public float 安魂祈祷层数 = 0;
        public float 爆发药剩余时间 = 0;
        public float 悔罪预备剩余时间 = 0;
        public float 沥血剑预备剩余时间 = 0;
        public float 赎罪剑预备剩余时间 = 0;
        public float 祈告剑预备剩余时间 = 0;
        public float 葬送剑预备剩余时间 = 0;
        public float 神圣领域剩余时间 = 0;
        public float 神圣魔法效果提高剩余时间 = 0;
        public int 自身减伤比例 = 0;
        public int 队伍减伤比例 = 0;
        public int 自身护盾 = 0;
        public int 队伍护盾 = 0;
