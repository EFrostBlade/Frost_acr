...
public class m2s起手 : IOpener
{
    ...
    public void InitCountDown(CountDownHandler countDownHandler)
    {
        ...
        countDownHandler.AddAction(20000, 战栗);
        countDownHandler.AddAction(15000, 原初的血气);
        countDownHandler.AddAction(14000, 摆脱);

        countDownHandler.AddAction(10000, 冲刺);
    ...
    {
        LogHelper.Print($"Step:{Core.Me.Position}");
