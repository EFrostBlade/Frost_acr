...
public class m1s起手 : IOpener
{
    ...
    public void InitCountDown(CountDownHandler countDownHandler)
    {
        ...
        countDownHandler.AddAction(15000, 战栗);
        countDownHandler.AddAction(14000, 原初的血气);
        countDownHandler.AddAction(13000, 冲刺);
        countDownHandler.AddAction(10000, 摆脱);

        countDownHandler.AddAction(2000, 戮罪);
